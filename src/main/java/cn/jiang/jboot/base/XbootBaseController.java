 ...
 * @author jiang
 */
public abstract class JbootBaseController<E, ID extends Serializable> {
     ...
     */
    @Autowired
    public abstract cn.jiang.jboot.base.JbootBaseService<E,ID> getService();
