package cn.jiang.jboot.generator;

import cn.jiang.jboot.generator.bean.EntityOfEntity;
...
public class JbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "jiang";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "cn.jiang.jboot.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "cn.jiang.jboot.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "cn.jiang.jboot.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "cn.jiang.jboot.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "cn.jiang.jboot.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/cn/jiang/jboot/controller/"+className+"Controller.java";
