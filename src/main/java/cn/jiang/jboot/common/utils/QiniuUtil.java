package cn.jiang.jboot.common.utils;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "jgjWeh4eLhm6LVkqZfTLPc0pM_QVc5OxNh6CZSDB";

    private static String secretKey = "jKHVUBKfff1qRncaI0jrhHPcSDD_ce8mjR52OHEH";

    private static String bucket = "xmal";

    private static String domain = "http://p0miyqid4.bkt.clouddn.com/";
